...
public class MediaFileDao extends AbstractDao<MediaFile, Long> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MEDIA_FILE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MEDIA_FILE\"";
        db.execSQL(sql);
    }
    ...
    @Override
    protected final Long updateKeyAfterInsert(MediaFile entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MediaFile entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
